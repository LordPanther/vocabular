...
class CollectionsBloc extends Bloc<CollectionsEvent, CollectionsState> {
  ...
  Future<void> _mapLoadCollectionsToState(event, Emitter<CollectionsState> emit) async {
    try {
      ...
      _fetchCollectionsSub = _collectionsRepository
          ...
          .listen((collections) => add(CollectionsUpdated(collections as CollectionsModel)));
    } catch (e) {
